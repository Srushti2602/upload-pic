...
def search_elastic_search(labels):
    ...
    url = 'https://search-photos-new-awbo5syy5gjznskb3oflfggoa4.us-east-1.es.amazonaws.com/photos_new/_search?q='
    resp = []
    for label in labels:
        ...
        if 'hits' in r:
             for val in r['hits']['hits']:
                ...
                if key not in output:
                    output.append("https://photob2.s3.amazonaws.com/"+key)
    print(output)
    return output
